...
const dict: Record<string, { zh: string; en: string; ja: string; ko: string; vi: string }> = {
  ...
  'monitor-errors': { zh: '發現 {n} 個錯誤（點我查看）', en: '{n} error(s) found (click to view)', ja: '{n} 個のエラーを検出（クリックで確認）', ko: '오류 {n}개 발견 (클릭하여 확인)', vi: 'Phát hiện {n} lỗi (nhấp để xem)' },
  ...
  'whisper-bar': { zh: '錄音中…（停止後自動轉錄）', en: 'Recording…（auto-transcribe on stop）', ja: '録音中…（停止後に自動で文字起こし）', ko: '녹음 중…（중지 후 자동 변환）', vi: 'Đang ghi âm…（tự động chuyển đổi sau khi dừng）' },
  ...
  // PM-426：設計稿畫面 08 底部的操作指引。原本沒有這一句——
  //   使用者最常卡的其實是「Chrome 的授權提示長在網址列下方，沒看到」。
  'mperm-hint': {
    zh: '請在瀏覽器上方的提示中選擇「允許」',
    en: 'Choose “Allow” in the prompt at the top of your browser',
    ja: 'ブラウザ上部のプロンプトで「許可」を選んでください',
    ko: '브라우저 상단의 알림에서 “허용”을 선택하세요',
    vi: 'Chọn “Cho phép” trong thông báo ở phía trên trình duyệt',
  },
  ...
  'annotate-pen': { zh: '畫筆', en: 'Pen', ja: 'ペン', ko: '펜', vi: 'Bút' },
  'annotate-arrow': { zh: '箭頭', en: 'Arrow', ja: '矢印', ko: '화살표', vi: 'Mũi tên' },
  ...
  'an-voice-stopped': { zh: '語音已停止', en: 'Voice stopped', ja: '音声を停止しました', ko: '음성이 중지되었습니다', vi: 'Đã dừng giọng nói' },
  'an-transcribing': { zh: '轉錄中…', en: 'Transcribing…', ja: '文字起こし中…', ko: '변환 중…', vi: 'Đang chuyển văn bản…' },
  'an-transcribed': { zh: '已轉錄', en: 'Transcribed', ja: '文字起こし完了', ko: '변환 완료', vi: 'Đã chuyển văn bản' },
  'an-transcribe-fail': { zh: '轉錄失敗，可改用鍵盤輸入', en: 'Transcription failed — you can type instead', ja: '文字起こしに失敗しました。キーボード入力に切り替えられます', ko: '변환에 실패했습니다. 키보드로 입력할 수 있습니다', vi: 'Chuyển văn bản thất bại — bạn có thể gõ thay thế' },
  'an-keyboard-mode': { zh: '鍵盤模式（語音已關閉）', en: 'Keyboard mode (voice off)', ja: 'キーボードモード（音声オフ）', ko: '키보드 모드 (음성 꺼짐)', vi: 'Chế độ bàn phím (tắt giọng nói)' },
  'an-voice-off': { zh: '語音已關閉，可按麥克風鍵開啟', en: 'Voice off — press the mic button to enable', ja: '音声はオフです。マイクボタンで有効にできます', ko: '음성이 꺼져 있습니다. 마이크 버튼으로 켤 수 있습니다', vi: 'Đã tắt giọng nói — nhấn nút micro để bật' },
  'an-processing': { zh: '處理中…', en: 'Processing…', ja: '処理中…', ko: '처리 중…', vi: 'Đang xử lý…' },
  'an-mic-fail': { zh: '麥克風無法存取', en: 'Microphone unavailable', ja: 'マイクにアクセスできません', ko: '마이크에 접근할 수 없습니다', vi: 'Không truy cập được micro' },
  'an-voice-error': { zh: '語音錯誤：{e}', en: 'Voice error: {e}', ja: '音声エラー：{e}', ko: '음성 오류: {e}', vi: 'Lỗi giọng nói: {e}' },
  ...
  'an-whisper-recording': {
    ...
    en: 'Whisper recording — press stop when done to transcribe…',
    ja: 'Whisper 録音中 — 話し終えたら停止ボタンで文字起こし…',
    ko: 'Whisper 녹음 중 — 말이 끝나면 정지 버튼을 눌러 변환…',
    vi: 'Whisper đang ghi — nhấn nút dừng khi xong để chuyển văn bản…',
  },
  ...
  'an-whisper-prompt': {
    zh: '付費版 Whisper：按麥克風鍵錄音描述，講完按停止鍵轉錄',
    en: 'Premium Whisper: tap the mic button to record, stop when done to transcribe',
    ja: '有料版 Whisper：マイクボタンで録音し、停止ボタンで文字起こし',
    ko: '유료 Whisper: 마이크 버튼으로 녹음하고 정지 버튼으로 변환',
    vi: 'Whisper bản trả phí: nhấn nút micro để ghi, nhấn dừng để chuyển văn bản',
  },
  ...
  // PM-428：乾淨／原始模式的切換標籤原本硬寫在 edit-report.ts（帶 emoji，
  //   而且英文模式下也只會顯示中文）。'er-clean' 已有，補一個 'er-raw'。
  'er-raw': { zh: '原始模式', en: 'Raw mode', ja: 'オリジナル表示', ko: '원본 모드', vi: 'Chế độ gốc' },
  ...
  'er-voice-interrupted': { zh: '語音中斷，按麥克風鍵重新啟動', en: 'Voice interrupted — press the mic button to restart', ja: '音声が中断されました — マイクボタンで再開', ko: '음성이 중단되었습니다 — 마이크 버튼으로 다시 시작', vi: 'Giọng nói bị gián đoạn — nhấn nút micro để khởi động lại' },
