...
const dict: Record<string, Record<UILang, string>> = {
  ...
  'caption-listening': { zh: '🟢 聽取中…', en: '🟢 Listening…' },
  'caption-restarting': { zh: '🟡 重啟中…', en: '🟡 Restarting…' },
  'caption-stopped': { zh: '🔴 已停止', en: '🔴 Stopped' },
  'caption-note-restart': { zh: '按 🔄 重啟', en: 'Press 🔄 to restart' },
  ...
  'er-summary-h': { zh: '📊 錄製摘要', en: '📊 Recording Summary' },
  'er-marker-h': { zh: '📌 時間軸標記', en: '📌 Timeline Markers' },
  'er-clean': { zh: '🧹 乾淨模式', en: '🧹 Clean View' },
  'er-mark': { zh: '📌 標記此刻', en: '📌 Mark Now' },
  'er-voice-h': { zh: '🎤 語音記錄（自動辨識）', en: '🎤 Voice Transcript (auto)' },
  'er-ai-correct': { zh: '🔧 AI 校正', en: '🔧 AI Fix' },
  'er-ai-summarize': { zh: '🤖 AI 精簡', en: '🤖 AI Summarize' },
  'er-voice-ph': { zh: '（這次錄製沒有語音）', en: '(No voice in this recording)' },
  'er-desc-h': { zh: '💬 補充說明（選填）', en: '💬 Notes (optional)' },
  'er-desc-ph': { zh: '打字或按右邊麥克風語音補充...', en: 'Type, or use the mic on the right to dictate...' },
  'er-token-h': { zh: '📊 Token 估算', en: '📊 Token Estimate' },
  ...
  'er-correcting': { zh: '🔧 校正中...', en: '🔧 Fixing...' },
  ...
  'er-summarizing': { zh: '🤖 精簡中...', en: '🤖 Summarizing...' },
  ...
  'er-tok-compare': { zh: '💡 同場景 Claude in Chrome：', en: '💡 Same task with Claude in Chrome: ' },
