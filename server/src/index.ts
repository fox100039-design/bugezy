...
<body>
  ...
  <footer>
    ...
    <div style="margin-top:8px;color:#555;">© 2026 BugEzy · v1.1.3 · ${t('亞洲平價 MCP 語音除錯工具', 'Affordable MCP voice debugging for Asia')}</div>
  </footer>
</body>
</html>`;
}
...
### 支援語言
- ✅ 現已支援：繁體中文（zh-TW）、粵語（yue-Hant-HK）、English（en-US）
- 🔜 即將開放：日本語、한국어、Tiếng Việt

### 兩種語音引擎
- **即時字幕（Web Speech API）**：免費版，頁面內即時轉字幕，零成本
- **精準轉錄（Groq Whisper）**：付費版，高準確度
  - 中文 / 粵語一律**強制輸出繁體中文**（server 端加 prompt 引導，v1.1.3 修）
...
<div class="wrap">
  ...
  <footer>
    ...
    <div style="margin-top:8px;">${t('聯絡', 'Contact')}：<a href="mailto:fox100039@gmail.com">fox100039@gmail.com</a></div>
    <div style="margin-top:8px;color:#555;">© 2026 BugEzy · v1.1.3</div>
  </footer>
</div>
</body>
</html>`;
