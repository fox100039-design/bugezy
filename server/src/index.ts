...
<head>
  ...
  <style>
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .lang-switch { position:fixed; top:14px; right:16px; z-index:20; background:#1a1a2e; border:1px solid #7c3aed; border-radius:8px; padding:5px 12px; font-size:13px; color:#c4b5fd; }
...
<body>
  ...
  <section class="wrap langs">
    ...
    <p class="sec-sub">${t('支援三種語言語音輸入，更多語言即將開放', 'Voice input in 3 languages, more coming soon')}</p>
    ...
    <div class="badges">
      ...
      <span class="badge soon">🇯🇵 日本語</span>
      <span class="badge soon">🇰🇷 한국어</span>
      <span class="badge soon">🇻🇳 Tiếng Việt</span>
    </div>
  </section>
...
<div class="wrap">
  ...
  <div class="feat">
    ...
    <div>
      ...
      <span class="badge2 soon">🇯🇵 日本語</span>
      <span class="badge2 soon">🇰🇷 한국어</span>
      <span class="badge2 soon">🇻🇳 Tiếng Việt</span>
    </div>
  </div>
